...
Source: "enable-full-keys.cmd"; DestDir: "{app}"; Flags: ignoreversion
Source: "disable-full-keys.cmd"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\启用完整按键模式"; Filename: "{app}\enable-full-keys.cmd"; WorkingDir: "{app}"; Flags: runminimized
Name: "{group}\关闭完整按键模式"; Filename: "{app}\disable-full-keys.cmd"; WorkingDir: "{app}"; Flags: runminimized
