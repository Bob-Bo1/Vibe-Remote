...
Item {
    ...
    RowLayout {
        ...
        objectName: "legacyRc003MappingLayout"
        // The visual RC003 page is provided by Rc003MappingPage below.
        // Keep this legacy object hidden for the established page-switch seam.
        visible: false
        anchors.fill: parent
            ...
            Rectangle {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        objectName: "legacyPhotoHotspot_" + buttonId
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                AppButton {
                    ...
                    objectName: "legacySaveMappingButton"
                    text: qsTr("保存映射")
                    highlighted: true
            ...
            Rectangle {
                Layout.fillWidth: true
                implicitHeight: detectionRow.implicitHeight + tokens.spacingLarge * 2
                ...
                RowLayout {
                    ...
                    AppButton {
                        ...
                        objectName: "legacyDetectRealKeyButton"
            ...
            GridView {
                id: mappingList
                objectName: "legacyMappingList"
                Layout.fillWidth: true
                Layout.fillHeight: true
                clip: true
                model: ButtonMappingModel
                ScrollBar.vertical: ScrollBar { policy: ScrollBar.AsNeeded }
                cellWidth: width >= 740 ? Math.floor(width / 2) : width
                cellHeight: 132
                ...
                onWidthChanged: Qt.callLater(function() {
                    mappingList.forceLayout()
                    mappingList.positionViewAtIndex(mappingList.currentIndex, GridView.Contain)
                })
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        AppTextField {
                            ...
                            placeholderText: qsTr("微信：长按 lctrl+lwin；其他输入法填对应快捷键")
                            selectByMouse: true
                    ...
                    Label {
                        ...
                        visible: mappingRow.isMic
                        text: qsTr("当前预设：") + SettingsController.voiceAppDescription
                        color: tokens.textSecondary
                        font.pixelSize: tokens.fontSizeSmall
                        elide: Text.ElideRight
                    }
