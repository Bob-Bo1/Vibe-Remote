"""Legacy child-process bridge launcher (XRBM-029), retained for the CMD
fallback and source/dev runs.  The packaged settings window uses
``integrated_bridge.py`` so configuration and bridge stay in one application.

This module launches the bridge process and
