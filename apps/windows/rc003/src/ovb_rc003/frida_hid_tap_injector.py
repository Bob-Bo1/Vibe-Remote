...
def inject_current_process(pid: int) -> None:
    ...
    # WUDFHost can reject even PROCESS_QUERY_LIMITED_INFORMATION until the
    # elevated caller has enabled SeDebugPrivilege.  Enable it before the
    # identity check so direct elevated launches and the admin CMD use the
    # same token capabilities.
