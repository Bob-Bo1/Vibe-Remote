...
_TRIGGER_MODE_LABELS = {
    key_mapping.VoiceTriggerMode.TOGGLE: "点击切换",
...
_MIC_ROW_DISPLAY = "触发语音（按当前设置的组合键）"
...
def build_save_model(
    *,
    ...
    voice_input_target: str = key_mapping.VOICE_APP_DEFAULT,
) -> Tuple[dict, dict]:
    ...
    new_config["voice_input_target"] = key_mapping.voice_app_for_settings(
        voice_input_target, hotkey_text, trigger_mode
    )
